...
public class ArmorMaterials {
    ...
    public static final RegistryObject<ArmorMaterial> COPPER = ARMORS.register("copper", () -> new ArmorMaterial(
    ...
    public static final RegistryObject<ArmorMaterial> WAXED_COPPER = ARMORS.register("waxed_copper", () -> new ArmorMaterial(
        Util.make(new EnumMap<>(ArmorItem.Type.class), map -> {
            map.put(ArmorItem.Type.HELMET, 2);
            map.put(ArmorItem.Type.CHESTPLATE, 6);
            map.put(ArmorItem.Type.LEGGINGS, 5);
